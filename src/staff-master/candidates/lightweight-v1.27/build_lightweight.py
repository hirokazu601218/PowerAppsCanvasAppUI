...
props(summary,Height='Max(96,lblPersonSub111.Y+lblPersonSub111.Height+8)')
for child in summary['conPerson111']['Children']:
 name=next(iter(child))
 if name=='lblName111':props(child,Width='Max(80,Parent.Width-128)',AutoHeight='true')
 if name=='lblPersonSub111':props(child,Y='Max(lblName111.Y+lblName111.Height,lblBadge111.Y+lblBadge111.Height)+4',AutoHeight='true')
 if name=='lblBadge111':props(child,X='Parent.Width-96')
nav=[]
