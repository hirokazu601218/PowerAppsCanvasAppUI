# Power Apps無人修正・テスト・公開基盤 要件定義書 v1.00
...
| AUT-008 | P0合格済み公開アプリをアンマネージドSolutionへ追加し、Git統合対応形式で初期取込みする。 |
...
| AUT-019 | 同一原因が2回連続した場合、自動修復を停止する。 |
...
5. 同一原因2回の停止ケースで合格版へ復元し、PR終了、ブランチ保持、Issue記録を確認できる。
