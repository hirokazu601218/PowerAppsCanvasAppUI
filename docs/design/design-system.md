...
- ヘッダーの左右余白は`Min(16,Max(0,(画面幅-1366)/2))`。キャンバス基準幅1366以下では追加0px、広いウィンドウでは最大16px。既存の本文左右16pxへ二重に余白を加えず、業務表示幅を保つ。
...
| 版 | 内容 |
|---|---|
| 1.04 | 自動テストv1.14の項目密度、最大6列、氏名横状態、選択背景、区切り線#E2E8F0、幅依存のヘッダー余白を追加 |
