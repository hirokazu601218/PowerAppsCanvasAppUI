> **2026-09-26 方針変更**：下記の複数アプリ間import・自動配布資格は過去の試験記録。[現在の運用](single-app-workflow.md)は旧編集用App ID `204a48dc-7f23-43dd-b934-4654a3cfa306` の1件。旧App ID `362ac991-eead-4f07-8373-afdb3ebfdba1` 向けワークフローを現行アプリへ起動・転用しない。自動化の新対象での実証は未了。
