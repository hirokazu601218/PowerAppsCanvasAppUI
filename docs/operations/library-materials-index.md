...
| PowerApps-v127-stable-payroll.jpg | `/非常勤給与/PowerApps-v127-stable-payroll.jpg` | 公開Player確認画像 | 安定版v1.27、職員011・給与1列・163項目の表示証跡（2026-09-24 09:02 UTC頃） | 軽量版の公開結果確認時 | 画像原本。合否はGitHub検証記録を参照 |
